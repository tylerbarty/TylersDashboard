...
# chart to show relationship between speed and all other attributes
...
### Uncomment comments  to show students how the dataframe changes
...
# st.bar_chart(df_single_racer, y=['Speed','Acceleration','Weight','Handling','Traction/Grip','Mini-Turbo'])
